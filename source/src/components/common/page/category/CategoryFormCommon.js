    ...
    return (
        ...
        >
            <Card className="card-form" bordered={false}>
                ...
                <Row gutter={10}>
                    <Col span={12}>
                        <TextField required label={translate.formatMessage(commonMessage.Name)} name={fieldsName.name} />
                    </Col>
                    <Col span={12}>
                        <SelectField name="status" label={translate.formatMessage(commonMessage.status)} allowClear={false} options={statusValues} />
                    </Col>
                </Row>
                <Row gutter={10}>
                    <Col span={24}>
                        <TextField required label={translate.formatMessage(commonMessage.description)} name={fieldsName.description} type="textarea" />
                    </Col>
                </Row>
