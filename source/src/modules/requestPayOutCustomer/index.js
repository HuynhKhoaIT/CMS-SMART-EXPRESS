...
const message = defineMessages({
    objectName: "Yêu cầu rút tiền khách hàng",
});
const RequestPatOutListPageCustomer = () => {
        ...
        override: (funcs) => {
            funcs.getList = () => {
                ...
                mixinFuncs.handleFetchList({
                    ...
                    kind:REQUEST_PAYOUT_KIND_CUSTOMER,
                    ...params,
...
export default RequestPatOutListPageCustomer;
